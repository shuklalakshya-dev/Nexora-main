    ...
    return (
        <div className='h-screen space-y-5'>
            ...
            <section className=" bg-black h-full">
                   <div className=' py-10'>
                    <h1 className="text-2xl z-100 font-semibold text-center text-gray-800 capitalize lg:text-3xl dark:text-white">Our <span className="text-[#0de415]">Executive Team</span></h1>
                    ...
                    <div className="relative w-full max-w-xxl px-10 py-3">
                  <div
                   className="absolute inset-0 h-full w-full scale-[0.80] transform rounded-full bg-red-200 bg-gradient-to-r from-[#0de415] to-teal-200 blur-3xl" />
                 <div
                   className="relative flex h-full flex-col items-start justify-end overflow-hidden rounded-2xl border border-gray-800 bg-black opacity-85 px-4 py-8 shadow-xl">
                  <div
          ...
          <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group  dark:border-gray-700 dark:hover:border-transparent">
                            <div className="flex flex-col sm:-mx-4 sm:flex-row">
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    <h1 className="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">AVNEESH YADAV</h1>
        ...
        <div
          ...
          <div className="px-12 py-8 transition-colors duration-300 transform border cursor-pointer rounded-xl hover:border-transparent group dark:border-gray-700 dark:hover:border-transparent">
                            <div className="flex flex-col sm:-mx-4 sm:flex-row">
                                ...
                                <div className="mt-4 sm:mx-4 sm:mt-0">
                                    <h1 className="text-xl font-semibold text-gray-700 capitalize md:text-2xl dark:text-white group-hover:text-white">LAKSHYA SHUKLA</h1>
